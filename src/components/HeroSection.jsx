          ...
          <div className="flex-none md:flex-1 z-10">
            ...
            >
              <span className="block text-gray-950 hero-text interactive cursor-default">
                {'SANIKA'.split('').map((c, i) => <span key={i} className="glitch-char">{c}</span>)}
              </span>
              <span
                className="block hero-text interactive cursor-default"
                style={{ color: '#C0BFC4' }}
              >
                {'DALAL'.split('').map((c, i) => <span key={i} className="glitch-char">{c}</span>)}
              </span>
            </h1>

            {/* Bio */}
            <p className="mt-5 text-gray-400 text-sm md:text-base font-normal leading-relaxed max-w-[52ch]">
              Building software with purpose, curiosity. Engineer, problem solver,
              and always up for turning ideas into clean, impactful, user-friendly products.
            </p>

            <p className="mt-3 text-gray-500 text-sm tracking-wide">Based in Bangalore, India</p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">full-time & remote</p>
              </div>
            </div>
