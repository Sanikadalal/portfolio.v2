...
const projects = [
  {
    ...
    description: 'A visual design and print project exploring typography beyond conventional letterforms.',
    tech: ['Visual Design', 'Print', 'Typography'],
    github: '',
    url: '/work/beyond-the-letter',
    num: '01',
  },
  {
    title: 'EchoTouch',
    description: 'An accessibility-focused UI/UX project designed to make digital experiences more inclusive.',
    tech: ['UI/UX', 'Accessibility', 'Figma'],
    github: '',
    url: '/work/echotouch',
    num: '02',
  },
  {
    ...
    description: 'A campaign and marketing initiative empowering young women through thoughtful visual storytelling.',
    tech: ['Campaign', 'Marketing', 'Branding'],
    github: '',
    url: '/work/every-girl-a-bright-future',
    num: '03',
  },
  {
    title: 'Sofy',
    description: 'A comprehensive UI/UX design system built for a modern consumer product brand.',
    tech: ['UI/UX', 'Design System', 'Figma'],
    github: '',
    url: '/work/sofy',
    num: '04',
  },
