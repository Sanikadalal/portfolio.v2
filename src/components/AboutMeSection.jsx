          ...
          >
            ...
            <div style={{ lineHeight: 2, color: '#555', fontSize: 'clamp(13px, 2vw, 15px)' }}>
              <p style={{ marginBottom: 16 }}>
                I'm a <strong>Software Engineer</strong> with a passion for building clean, scalable, and user-friendly applications. I love exploring how technology can solve real problems and make everyday experiences more meaningful.
              </p>
              <p style={{ marginBottom: 16 }}>
                With experience across <strong>full-stack development, system design, and software engineering</strong>, I've worked on a variety of projects that span web apps, APIs, and beyond.
              </p>
              <p style={{ marginBottom: 20 }}>
                My journey started with a curiosity for <strong>how things work under the hood</strong>, and that same curiosity still drives how I approach every problem today — with logic, creativity, and a genuine interest in building things that matter.
              </p>
            </div>

            <p style={{ lineHeight: 2, color: '#555', fontSize: 'clamp(13px, 2vw, 15px)' }}>
              Currently open to <strong>full-time roles & internships</strong>. If you're building something exciting, let's talk!
            </p>
          </div>
